...
exports.init = () => {
    Promise.all([
         ...
         */
        db.raw(`SELECT p.id, p_f.upvoters FROM projects AS p
...
exports.fetchSubscribers = (id) => {
    /**
     * Fetch list of following, followers ID for a specified user
     * TODO check on server init for all users ?
     */
    return db.raw(`
